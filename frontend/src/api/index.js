...
export const universityApi = {
  ...
  getBySlug:      (slug, config) => api.get(`/universities/${slug}`, config),
...
export const organizationApi = {
  list: (params, config = {}) => api.get('/organizations', { ...config, params }),
  getMine: () => api.get('/organizations/mine'),
  getBySlug: (slug, config) => api.get(`/organizations/${slug}`, config),
  updateMine: (data) => api.put('/organizations/mine', data),
  getFAQs: (organizationId) => api.get(`/organizations/${organizationId}/faqs`),
  createFAQ: (organizationId, data) => api.post(`/organizations/${organizationId}/faqs`, data),
  updateFAQ: (organizationId, id, data) => api.put(`/organizations/${organizationId}/faqs/${id}`, data),
  deleteFAQ: (organizationId, id) => api.delete(`/organizations/${organizationId}/faqs/${id}`),
  getContact: (organizationId) => api.get(`/organizations/${organizationId}/contact`),
  upsertContact: (organizationId, data) => api.put(`/organizations/${organizationId}/contact`, data),
  getNews: (organizationId, params) => api.get(`/organizations/${organizationId}/news`, { params }),
  createNews: (organizationId, data) => api.post(`/organizations/${organizationId}/news`, data),
  updateNews: (organizationId, id, data) => api.put(`/organizations/${organizationId}/news/${id}`, data),
  deleteNews: (organizationId, id) => api.delete(`/organizations/${organizationId}/news/${id}`),
  getEvents: (organizationId, params) => api.get(`/organizations/${organizationId}/events`, { params }),
  createEvent: (organizationId, data) => api.post(`/organizations/${organizationId}/events`, data),
  updateEvent: (organizationId, id, data) => api.put(`/organizations/${organizationId}/events/${id}`, data),
  deleteEvent: (organizationId, id) => api.delete(`/organizations/${organizationId}/events/${id}`),
  getReviews: (organizationId, params) => api.get(`/organizations/${organizationId}/reviews`, { params }),
  createReview: (organizationId, data) => api.post(`/organizations/${organizationId}/reviews`, data),
  getOwnerReviews: (organizationId) => api.get(`/organizations/${organizationId}/reviews/owner`),
  approveReview: (organizationId, id) => api.put(`/organizations/${organizationId}/reviews/${id}/approve`),
  replyToReview: (organizationId, id, data) => api.put(`/organizations/${organizationId}/reviews/${id}/owner-reply`, data),
  deleteReview: (organizationId, id) => api.delete(`/organizations/${organizationId}/reviews/${id}`),
};
...
export const majorApi = {
  ...
  getBySlug:         (slug, config)   => api.get(`/majors/${slug}`, config),
...
export const opportunityApi = {
  ...
  getBySlug:      (slug, config)     => api.get(`/opportunities/${slug}`, config),
