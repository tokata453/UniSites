...
const uploadGallery = multer({ storage: createStorage('gallery'),  limits: { fileSize: 20 * 1024 * 1024 } });
const uploadCover   = multer({ storage: createStorage('covers'),   limits: { fileSize: 20 * 1024 * 1024 } });
const uploadLogo    = multer({ storage: createStorage('logos'),    limits: { fileSize: 5  * 1024 * 1024 } });
const uploadGeneral = multer({ storage: createStorage('general'),  limits: { fileSize: 20 * 1024 * 1024 } });
